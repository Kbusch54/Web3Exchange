    ...
    return (
        <div className="m-6 ">
            <div className="flex flex-row justify-between animate-pulse">
                <div className="mt-12 ml-24 text-white  ">
                    <h1 className="h-20 w-64 md:w-80 lg:w-[50rem] bg-gray-300 rounded-full dark:bg-gray-600  mb-2.5 "></h1>
            ...
            <div className="flex flex-row justify-center mx-2 my-8  md:m-8 border-4 border-amber-400 mt-32">
                ...
                <svg className="h-64 w-3/4 py-8 text-gray-200 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z" /></svg>
            </div>
            <div
              id={"stats"}
        ...
        <div className="inside-box">
          <div className="flex flex-col gap-y-4 animate-pulse ">
            ...
            <div className='bg-gray-400 w-32 h-8 animate-pulse rounded-full mt-12'></div>
              <div className='bg-gray-700 w-1/2 h-40 animate-pulse my-12 rounded-3xl'></div>
              <div className='bg-gray-400 w-32 h-8 animate-pulse rounded-full '></div>
              <div className='bg-gray-600 w-full h-20 animate-pulse rounded-3xl mt-4 '></div>
              <div className='bg-gray-700 w-72 h-32 animate-pulse rounded-full my-12'></div>
            </div>
        </div>
    )
}
